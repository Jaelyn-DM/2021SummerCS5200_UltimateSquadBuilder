...
public class RestfulCustomizedTeamServlet extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		CustomizedTeams updatedTeam = createOrUpdateCustomizedTeamHelper(teamWithIdsOnly);
	...
	private CustomizedTeams createOrUpdateCustomizedTeamHelper(final CustomizedTeams team) {
		System.out.println("Requesting team Id: " + team.getTeam_id());
		try {
			final CustomizedTeams existingTeam = customizedTeamsDao.getTeamById(team.getTeam_id());
			return existingTeam == null ? customizedTeamsDao.create(team) : customizedTeamsDao.updateTeamById(team);
		} catch (SQLException exception) {
			exception.printStackTrace();
			return null;
		}
